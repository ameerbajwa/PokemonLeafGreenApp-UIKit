...
//    var pokemonBattleTextView: PokemonBattleTextView
    ...
    init(navigationController: UINavigationController, pokeAPINetworkService: PokeAPINetworkService, coreDataNetworkService: CoreDataNetworkService, pokemonFullInfoLoadingService: PokemonFullInfoLoading, playerPokemonSquadManager: PlayerPokemonSquadManager, opposingBattleConfiguration: PokemonBattleConfiguration) {
